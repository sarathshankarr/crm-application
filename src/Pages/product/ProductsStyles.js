...
const ProductsStyles = ({ route }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-evenly', alignItems: 'center', marginBottom: 10, borderBottomWidth: 1, borderColor: 'lightgray' }}>
        <Text style={{ color: '#000', fontWeight: 'bold', fontSize: 16, paddingVertical:10 }}>Select Type </Text>
        <RadioGroup
          radioButtons={radioButtons}
          onPress={setSelectedId}
          selectedId={selectedId}
